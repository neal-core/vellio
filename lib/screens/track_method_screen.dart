          ...
          child: Scaffold(
            body: Column(
              children: [
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            border: mthd['status'] == 'selected' ? Border.all(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                ...
                                setState(() {
                                  mthd['status'] = mthd['status'] == 'selected' ? 'unselected' : 'selected';
                                  selectedTM = mthd['status'] == 'selected' ? mthd['title'] : 'default';
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      height: 1,
                                      color: const Color(0xFF00B878).withOpacity(0.45),
                                    ),
                                          ...
                                          Container(
                                            ...
                                            child: Icon(
                                              mthd['status'] == 'selected'
                                                  ? Icons.check
                                                  : Icons.close,
                                              color: mthd['status'] == 'selected' ? Color(
                                                  0xFFE4D3D3) : Colors.black87,
                                              size: 34,
                                            ),
                                          ),
                                        ],
                ...
                ElevatedButton(onPressed: selectedTM != "default" ? () => print("Selected at least 1") : null, child: Text("Continue", style: Theme.of(context).textTheme.titleSmall,))
              ],
            ),
          )
      ),
